...
################################		FORENSICS		#########################################################################
		...
		print('\n			SHOULD BE NOTED THAT YOU WILL NEED A TO GET AN "IMAGE"  OR A CLONE OF COMPUTER YOU ARE COLLECTING FROM')
		print('				ONE GREAT WAY TO GET A CLONE OF A DEVICE IS USING "CLONEZILLA"')
		print('			HERE IS THE DOWNLOAD LINK FOR A LIVE USB CLONEZILLA    ---->>>>		     https://clonezilla.org/downloads.php \n')
...
###################################		MISC			###############################################################################
		...
		print(colored("1. Get A Computers Public IP Address Or Get A Websites Public IP Address"  , 'blue'))
		print(colored("2. How To Create An Evil-Twin", 'cyan'))
		print(colored("3. stegsnow", 'blue'))
		...
		if App10 == "1":
			...
			print(colored('OR\n', 'red'))
			print(colored("nano IP.py", 'green'))
			print('^ This Creates A Python File, We Will Set It Up So All You Need To Do When You Run The Program Is Type Out The Websites URL. ^\n')

			print(colored('				COPY AND PASTE THE FOLLOWING CONTENTS ', 'yellow'))
			print(colored(" ''", 'yellow'))
			print(colored("import socket", 'green'))
			print(colored(" ", 'green'))
			print(colored("x = input('What Is The Websites URL: ')", 'green'))
			print(colored("IP_address = socket.gethostbyname(x)", 'green'))
			print(colored("print(IP_address)", 'green'))
			print(colored("''", 'yellow'))

			print('^ Press <CTRL + o> And Press <ENTER>  To Save The File^')
			print('^Press <CTRL + x> To Exit ^\n')
			print(colored("chmod +x IP.py", 'green'))
			print('^ This Grants Permissions To Allow The File To Run ^\n')
			print(colored("python3 IP.py", 'green'))
			print('^ This Runs The Program ^ \n')
			...
			print(colored("stegsnow -h", 'green'))
			print('^ This Prints Out The Help Menu ^ \n')
			print('		YOU NEED A .TXT FILE FOR THIS, DOESNT MATTER WHICH ONE \n')
			print(colored("stegsnow -C -m '<Put Your Message Here>' -p '<Put Password Here>' <txt_file_name>.txt <new_file_name>.txt", 'green'))
			print('^ -C Compresses The Data, -m Defines The Message You Want To Encrypt, -p Is The Password ^')
			print('^ Now The 2 File Names. The First One Is A TXT File You Already Have, The Second One Will Be The New TXT File With Encrypted Message ^ \n')
			print(colored("stegsnow -C -p '<Put Password Here>' <new_file_name>.txt", 'green'))
			print('^ This Is How You Decrypt Hidden Message From The TXT File. ^ \n')
